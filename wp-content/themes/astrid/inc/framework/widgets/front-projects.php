						...
						<div class="project">
							...
							<div class="project-thumb">
								...
								<div class="project-content">
									<h3 class="project-title"><a href="<?php echo wp_get_attachment_url(get_post_thumbnail_id(get_the_ID())); //the_permalink(); ?>" data-lightbox="<?php the_title(); ?>" data-title="<?php the_title(); ?>"><?php the_title(); ?></a></h3>
								</div>
							</div>
							<?php endif; ?>
						</div>
